...
public class GoshLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "COMMA", "ASSIGN", "FUNC", "WS", "COMMENT", 
			"TERMINATOR", "LINE_COMMENT", "BREAK", "CONTINUE", "FOR", "EOS", "OUTER", 
			"L_PAREN", "R_PAREN", "L_CURLY", "R_CURLY", "RUN", "RETURN", "ELSE", 
			"IF", "ADD", "SUB", "EQUAL", "NOTEQUAL", "AND", "OR", "LESS", "LESS_EQUAL", 
			"GREATER", "GREATER_EQUAL", "Number", "ID", "Str"
		};
	}
	...
	public GoshLexer(CharStream input) {
		super(input);
